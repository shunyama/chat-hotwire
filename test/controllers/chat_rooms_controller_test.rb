...
class ChatRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chat_room" do
    assert_difference("ChatRoom.count") do
      post chat_rooms_url, params: { chat_room: { created_by: @chat_room.created_by, description: @chat_room.description, disabled: @chat_room.disabled, name: @chat_room.name } }
    end
  ...
  test "should update chat_room" do
    patch chat_room_url(@chat_room), params: { chat_room: { created_by: @chat_room.created_by, description: @chat_room.description, disabled: @chat_room.disabled, name: @chat_room.name } }
